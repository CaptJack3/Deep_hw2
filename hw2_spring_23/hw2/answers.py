...
def part2_optim_hp():
    ...
    # ====== YOUR CODE: ======
    wstd, lr_vanilla, lr_momentum, lr_rmsprop, reg, = (0.1,0.04,0.05,0.0005,0.001)
    # ========================
    return dict(
        wstd=wstd,
...
def part3_optim_hp():
    ...
    lr, weight_decay, momentum = 0.003, 0.01, 0.9  # Arguments for SGD optimizer
    # ========================
